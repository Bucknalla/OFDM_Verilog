...
HD_PWD='/home/alex/GitHub/IFFT_Verilog/Verilog/OFDM/ip_repo/edit_FFT_Controller_v0_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Controller_v0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Controller_v0_1.tcl
