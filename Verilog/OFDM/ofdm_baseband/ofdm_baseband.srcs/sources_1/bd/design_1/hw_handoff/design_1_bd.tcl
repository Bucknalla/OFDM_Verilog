...
CONFIG.number_of_stages_using_block_ram_for_data_and_phase_factors.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Cyclic_Prefix_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Pilot_Insertion_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins QAM_Modulator_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Pilot_Insertion_0/S00_AXI/S00_AXI_reg] SEG_Pilot_Insertion_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs QAM_Modulator_0/S00_AXI/S00_AXI_reg] SEG_QAM_Modulator_0_S00_AXI_reg
...
preplace port S00_AXIS -pg 1 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 420 -defaultsOSRD
preplace port M00_AXIS -pg 1 -y 250 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -y 220 -defaultsOSRD
preplace inst Pilot_Insertion_0 -pg 1 -lvl 5 -y 270 -defaultsOSRD
preplace inst QAM_Modulator_0 -pg 1 -lvl 4 -y 250 -defaultsOSRD
