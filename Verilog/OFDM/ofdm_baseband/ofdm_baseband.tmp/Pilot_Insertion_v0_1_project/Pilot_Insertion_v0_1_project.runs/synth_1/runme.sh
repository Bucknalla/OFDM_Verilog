...
HD_PWD='/home/alex/GitHub/IFFT_Verilog/Verilog/OFDM/ofdm_baseband/ofdm_baseband.tmp/Pilot_Insertion_v0_1_project/Pilot_Insertion_v0_1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pilot_Insertion_v0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pilot_Insertion_v0_1.tcl
